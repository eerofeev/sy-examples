 ...
 */
package com.gepardec.examples.switchyard_monitoring;
...
public class SLAMonitor {
    ...
    @Path("/responseTimes2")
    @Produces("application/json")
    public  Map<String, OperationReport> getResponseTimes2(
    					@QueryParam("serviceType") String serviceType,
    					@QueryParam("operation") String operation,
    					@QueryParam("fault") String fault) throws Exception {
    	
    	ActivityDBReaderRequestBuilder builder = new ActivityDBReaderRequestBuilder();
    	builder.fromTimeStamp(1419336000000L).service("ConverterProxy");
